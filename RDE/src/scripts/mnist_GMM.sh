...
# MNIST training   sh scripts/mnist_GMM.sh cpu mnist_0_deep_GMM 0 adam 0.0001 150 1 0 1 0 -1
python baseline.py --dataset mnist --solver $solver --loss deep_GMM --lr $lr --lr_drop 1 --lr_drop_in_epoch 50 \
    ...
    --hard_margin $hard_margin --nu 0.1 --weight_dict_init 1 --unit_norm_used l1 --gcn 1 --mnist_bias 1 \
